...
func newSchemaMigration(db *gorm.DB, opts ...gen.DOOption) schemaMigration {
	...
	_schemaMigration.schemaMigrationDo.UseModel(&entities.SchemaMigration{})
...
type ISchemaMigrationDo interface {
	...
	Create(values ...*entities.SchemaMigration) error
	CreateInBatches(values []*entities.SchemaMigration, batchSize int) error
	Save(values ...*entities.SchemaMigration) error
	First() (*entities.SchemaMigration, error)
	Take() (*entities.SchemaMigration, error)
	Last() (*entities.SchemaMigration, error)
	Find() ([]*entities.SchemaMigration, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entities.SchemaMigration, err error)
	FindInBatches(result *[]*entities.SchemaMigration, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entities.SchemaMigration) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entities.SchemaMigration, error)
	FirstOrCreate() (*entities.SchemaMigration, error)
	FindByPage(offset int, limit int) (result []*entities.SchemaMigration, count int64, err error)
...
func (s schemaMigrationDo) Create(values ...*entities.SchemaMigration) error {
	if len(values) == 0 {
		return nil
	}
...
func (s schemaMigrationDo) CreateInBatches(values []*entities.SchemaMigration, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s schemaMigrationDo) Save(values ...*entities.SchemaMigration) error {
	if len(values) == 0 {
		return nil
	}
...
func (s schemaMigrationDo) First() (*entities.SchemaMigration, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entities.SchemaMigration), nil
	}
}

func (s schemaMigrationDo) Take() (*entities.SchemaMigration, error) {
...
func (s schemaMigrationDo) Last() (*entities.SchemaMigration, error) {
...
func (s schemaMigrationDo) Find() ([]*entities.SchemaMigration, error) {
	result, err := s.DO.Find()
	return result.([]*entities.SchemaMigration), err
}

func (s schemaMigrationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entities.SchemaMigration, err error) {
	buf := make([]*entities.SchemaMigration, 0, batchSize)
...
func (s schemaMigrationDo) FindInBatches(result *[]*entities.SchemaMigration, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s schemaMigrationDo) FirstOrInit() (*entities.SchemaMigration, error) {
...
func (s schemaMigrationDo) FirstOrCreate() (*entities.SchemaMigration, error) {
...
func (s schemaMigrationDo) FindByPage(offset int, limit int) (result []*entities.SchemaMigration, count int64, err error) {
...
func (s schemaMigrationDo) Delete(models ...*entities.SchemaMigration) (result gen.ResultInfo, err error) {
